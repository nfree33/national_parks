...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { avg_visitors: @park.avg_visitors, description: @park.description, location: @park.location, name: @park.name } }, as: :json
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { avg_visitors: @park.avg_visitors, description: @park.description, location: @park.location, name: @park.name } }, as: :json
    assert_response 200
  end
